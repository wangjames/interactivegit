...
var text_object_4 = `Now we will create our local repository similar to how we did it for Lesson One, and configure it properly. 
...
var text_object_5 = `Now that we've made a commit, we want to push our version of our branch to GitBoat so that everyone can see it.
...
var text_object_6 = `Now that your repository is correctly configured, you can push your commits to the repository. The way we do this is by pushing our entire
...
var text_object_7 = `Go to the GitBoat visualization and see that the repository that you've pushed to now has the commits that you wanted.`
