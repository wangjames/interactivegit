var text_object_1 =`Now with our repository set up, we can start looking at how people can collaborate with Git. 
...
When a repository is first created, we have to initialize a repository with our project. Let’s do that now.`
 
var text_object_2 = `You have been provided with a test project. Feel free to create new files and folders using the linux commands touch and mkdir. 
Double clicking the files in the editor will open up a screen to make edits to the file.`
...
Make sure you’re in the root directory where you typed git init and type git add . 
